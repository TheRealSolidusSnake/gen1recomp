...
--
-- Sandbox killed require("ffi") for mods, so they can't load the DLL themselves
-- even when it's sitting right there.  We do it here, before any mod runs, and
-- the sandbox only lets them see getOS + the tls* keys (see Sandbox.lua).
--
